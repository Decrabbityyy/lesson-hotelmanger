...
internal class AddDoubleRoomMenuItem : IMenuItem<User>
{
    public static readonly AddDoubleRoomMenuItem Singleton  = new();
    ...
    public (IMenu?, object?) Run(ApplicationContext application, User? user)
    {
        while (true)
        {
            ...
            try
            {
                application.RoomService.CreateRoom(roomId, RoomType.Double, price);
            }
