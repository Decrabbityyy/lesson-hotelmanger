...
internal class AddSingleRoomMenuItem : IMenuItem<User>
{
    public static readonly AddSingleRoomMenuItem Singleton  = new();
    ...
    public (IMenu?, object?) Run(ApplicationContext application, User? user)
    {
        while (true)
        {
            ...
            try
            {
                application.RoomService.CreateRoom(roomId, RoomType.Single, price);
            }
