...
internal class AddAdminMenuItem : IMenuItem<User>
{
    public static readonly AddAdminMenuItem Singleton  = new();
    ...
    public (IMenu?, object?) Run(ApplicationContext application, User? user)
    {
        while (true)
        {
            ...
            try
            {
                application.UserService.CreateUser(username, password, UserRole.Admin);
            }
